...
hollr is pre-1.0. Security fixes are applied to the latest published release on
npm (`hollr-cli`). Please upgrade to the latest version before reporting.
...
1. Go to the [Security tab](https://github.com/paurushrai/hollr/security).
...
hollr is local-first. The only component that sends data off your machine is the
